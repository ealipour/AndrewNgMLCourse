...
%FEED FORWARD________________________



%h=zeros(m,1);
a2 = sigmoid(X*Theta1');
a2 = [ones(m, 1) a2];        %correct
a3 = sigmoid(a2*Theta2');   %correct
%%%%%[ip,p]= max(a3');
h = a3;
...
d3 = h-ymatrix;   %correct
nbTheta2 =Theta2(:,2:end);
nbTheta1 =Theta1(:,2:end);
Xo = X(:,2:end);
%z2 = Xo*nbTheta1'
z2 = X*Theta1';       %%correct
d2 = (d3* nbTheta2).*sigmoidGradient(z2);      %correct
%d2 = (d3*Theta2);
%d2 = d2(2:end);
